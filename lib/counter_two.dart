  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          ...
          if (streamSnapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Stack(
                  children: [
                    Container(height: MediaQuery.of(context).size.height/1.3,width: MediaQuery.of(context).size.width,
                      child: Center(
        ...
        _createOrUpdate(documentSnapshot);
            },child: Container(color: Colors.blue,height: 30,width: 110,child: Center(child: Text('RESET',style: TextStyle(fontSize: 14,fontWeight: FontWeight.bold,color: Color(0xffFFFFFF)),)),))
          ],
        ),
      ),
                    ),
